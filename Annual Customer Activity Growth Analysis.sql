...
--repeat order customer pertahun
repeat_order as(
...
--average of order fequensy pertahun
avg_order AS (
...
--combine all be one table
SELECT cm.year, cm.avg_mau, nc.new_customer, ro.repeat_order, ao.avg_frequency_order
from count_mau cm
